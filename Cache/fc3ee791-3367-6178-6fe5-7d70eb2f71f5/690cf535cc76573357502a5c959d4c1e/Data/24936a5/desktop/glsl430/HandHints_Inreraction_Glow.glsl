...
//spec_const int Tweak_N6Layout 80 0
...
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_26=texture(Tweak_N6ArrSC,l9_25,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
...
#else
{
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_29=l9_1.x;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_30=l9_29;
float l9_31=l9_1.y;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
#if (SC_USE_UV_MIN_MAX_Tweak_N6)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
...
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_28,l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_50=texture(Tweak_N6,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_51=mix(Tweak_N6BorderColor,l9_50,vec4(l9_48));
}
#else
{
l9_51=l9_50;
...
#endif
vec4 l9_52=Port_Value_N017+l9_3;
vec4 l9_53=l9_52*l9_3;
vec4 l9_54=(l9_53*Port_Value_N017)*vec4(glowIntensity);
vec3 l9_55=Port_Color_N011.xyz*Port_Color_N011.w;
float l9_56=l9_54.x;
vec4 l9_57=vec4(min(vec4(l9_55.x,l9_55.y,l9_55.z,Port_Color_N011.w)+l9_54,vec4(1.0)).xyz,l9_56);
...
{
l9_63=clamp(dot(l9_57.xyz,vec3(l9_56)),0.0,1.0);
}
#else
{
float l9_64;
...
{
l9_65=(1.0-dot(l9_57.xyz,vec3(0.33333001)))*l9_56;
}
#else
{
float l9_66;
...
{
l9_66=(1.0-clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0))*l9_56;
}
#else
{
float l9_67;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_69=clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0)*l9_56;
}
#else
{
float l9_70;
...
{
l9_70=dot(l9_57.xyz,vec3(0.33333001))*l9_56;
}
#else
{
float l9_71;
...
{
l9_77=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_76,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_77=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_76,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_75=l9_77;
}
#endif
vec3 l9_78=mix(l9_75.xyz,definedBlend(l9_75.xyz,l9_57.xyz).xyz,vec3(l9_56));
