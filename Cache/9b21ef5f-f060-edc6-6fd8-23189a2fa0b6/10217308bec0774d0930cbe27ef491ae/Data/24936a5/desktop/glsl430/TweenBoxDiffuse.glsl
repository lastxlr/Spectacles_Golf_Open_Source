...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_240-0.0039215689)),min(1.0,l9_240+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_242),packValue(l9_242),packValue(l9_242),packValue(l9_242)));
}
#endif
}
#else
