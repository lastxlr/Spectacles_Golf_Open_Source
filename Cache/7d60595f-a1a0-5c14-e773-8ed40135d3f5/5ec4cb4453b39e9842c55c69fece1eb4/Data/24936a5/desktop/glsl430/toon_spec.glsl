...
#endif
#ifndef ENABLE_BASE_TEXTURE
#define ENABLE_BASE_TEXTURE 0
#elif ENABLE_BASE_TEXTURE==1
#undef ENABLE_BASE_TEXTURE
#define ENABLE_BASE_TEXTURE 1
#endif
...
#endif
#ifndef ENABLE_OPACITY_TEXTURE
#define ENABLE_OPACITY_TEXTURE 0
#elif ENABLE_OPACITY_TEXTURE==1
#undef ENABLE_OPACITY_TEXTURE
#define ENABLE_OPACITY_TEXTURE 1
#endif
...
uniform float specularPositionX;
uniform float specularPositionY;
uniform float Port_Value3_N061;
uniform mat4 sc_ModelMatrixInverse;
uniform vec4 baseColor;
uniform float shadowIntensity;
uniform float Port_Input0_N068;
...
void Node51_Construct_Matrix(vec3 RotationXYZ,vec3 Column3,out mat4 Matrix,ssGlobals Globals)
{
float l9_0=cos(radians(RotationXYZ.x));
float l9_1=sin(radians(RotationXYZ.x));
float l9_2=cos(radians(RotationXYZ.y));
float l9_3=sin(radians(RotationXYZ.y));
float l9_4=cos(radians(RotationXYZ.z));
float l9_5=sin(radians(RotationXYZ.z));
float l9_6=l9_1*l9_3;
float l9_7=l9_0*l9_3;
Matrix=mat4(vec4(l9_2*l9_4,(l9_0*l9_5)+(l9_6*l9_4),(l9_1*l9_5)-(l9_7*l9_4),0.0),vec4((-l9_2)*l9_5,(l9_0*l9_4)-(l9_6*l9_5),(l9_1*l9_4)+(l9_7*l9_5),0.0),vec4(l9_3,(-l9_1)*l9_2,l9_0*l9_2,0.0),vec4(Column3.x,Column3.y,Column3.z,1.0));
}
...
ssGlobals l9_6=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_4,l9_3,l9_2,l9_1);
vec3 l9_7;
...
#else
{
l9_7=vec3(Port_Input2_N028);
}
#endif
vec3 l9_57;
if ((float(lineWeight<clamp(dot(l9_3,l9_1),0.0,1.0))*1.0)!=0.0)
{
float l9_58=floor(1.0);
vec3 l9_59;
if (l9_58==0.0)
{
vec3 l9_60=(sc_ModelMatrixInverse*vec4(l9_1,1.0)).xyz;
mat4 l9_61;
Node51_Construct_Matrix(vec3(specularPositionX,specularPositionY,Port_Value3_N061),l9_60,l9_61,l9_6);
l9_59=(sc_ModelMatrix*vec4(mat3(l9_61[0].xyz,l9_61[1].xyz,l9_61[2].xyz)*l9_60,1.0)).xyz;
}
else
{
vec3 l9_62;
if (l9_58==1.0)
{
float l9_63=radians(specularPositionX);
float l9_64=cos(l9_63);
float l9_65=sin(l9_63);
float l9_66=radians(specularPositionY);
float l9_67=cos(l9_66);
float l9_68=sin(l9_66);
float l9_69=radians(Port_Value3_N061);
float l9_70=cos(l9_69);
float l9_71=sin(l9_69);
float l9_72=l9_65*l9_68;
float l9_73=l9_64*l9_68;
l9_62=mat3(vec4(l9_67*l9_70,(l9_64*l9_71)+(l9_72*l9_70),(l9_65*l9_71)-(l9_73*l9_70),0.0).xyz,vec4((-l9_67)*l9_71,(l9_64*l9_70)-(l9_72*l9_71),(l9_65*l9_70)+(l9_73*l9_71),0.0).xyz,vec4(l9_68,(-l9_65)*l9_67,l9_64*l9_67,0.0).xyz)*l9_1;
}
else
{
vec3 l9_74=(sc_ModelMatrixInverse*vec4(l9_1,1.0)).xyz;
mat4 l9_75;
Node51_Construct_Matrix(vec3(specularPositionX,specularPositionY,Port_Value3_N061),l9_74,l9_75,l9_6);
l9_62=(sc_ModelMatrix*vec4(mat3(l9_75[0].xyz,l9_75[1].xyz,l9_75[2].xyz)*l9_74,1.0)).xyz;
}
l9_59=l9_62;
}
vec3 l9_76;
if ((step(mix(Port_Input0_N068,Port_Input1_N068,specularSize),l9_59.z)*1.0)!=0.0)
{
l9_76=baseColor.xyz;
}
else
{
l9_76=baseColor.xyz*vec3(1.0-shadowIntensity);
}
l9_57=l9_76;
}
else
...
vec3 l9_77=l9_7*l9_57;
vec4 l9_78;
#if (ENABLE_OPACITY_TEXTURE)
{
vec4 l9_79;
#if (opacityTextureLayout==2)
{
bool l9_80=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_81=l9_4.x;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_82=l9_81;
float l9_83=l9_4.y;
sc_SoftwareWrapEarly(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_84=l9_83;
vec2 l9_85;
float l9_86;
...
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
...
float l9_88=l9_82;
float l9_89=1.0;
sc_ClampUV(l9_88,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_87,l9_89);
float l9_90=l9_88;
float l9_91=l9_89;
bool l9_92;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_92=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_92=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_93=l9_84;
float l9_94=l9_91;
sc_ClampUV(l9_93,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_92,l9_94);
l9_86=l9_94;
...
#endif
vec2 l9_95=sc_TransformUV(l9_85,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_96=l9_95.x;
float l9_97=l9_86;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_80,l9_97);
float l9_98=l9_95.y;
float l9_99=l9_97;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_80,l9_99);
float l9_100=l9_99;
vec3 l9_101=sc_SamplingCoordsViewToGlobal(vec2(l9_96,l9_98),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_102=texture(opacityTextureArrSC,l9_101,0.0);
vec4 l9_103;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_103=mix(opacityTextureBorderColor,l9_102,vec4(l9_100));
}
#else
{
l9_103=l9_102;
...
#else
{
bool l9_104=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0));
float l9_105=l9_4.x;
sc_SoftwareWrapEarly(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_106=l9_105;
float l9_107=l9_4.y;
sc_SoftwareWrapEarly(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_108=l9_107;
vec2 l9_109;
float l9_110;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_111=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_111=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_112=l9_106;
float l9_113=1.0;
sc_ClampUV(l9_112,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_111,l9_113);
float l9_114=l9_112;
float l9_115=l9_113;
bool l9_116;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_116=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_116=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_117=l9_108;
float l9_118=l9_115;
sc_ClampUV(l9_117,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_116,l9_118);
l9_110=l9_118;
...
#endif
vec2 l9_119=sc_TransformUV(l9_109,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_120=l9_119.x;
float l9_121=l9_110;
sc_SoftwareWrapLate(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,l9_104,l9_121);
float l9_122=l9_119.y;
float l9_123=l9_121;
sc_SoftwareWrapLate(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,l9_104,l9_123);
float l9_124=l9_123;
vec3 l9_125=sc_SamplingCoordsViewToGlobal(vec2(l9_120,l9_122),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_126=texture(opacityTexture,l9_125.xy,0.0);
vec4 l9_127;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_127=mix(opacityTextureBorderColor,l9_126,vec4(l9_124));
}
#else
{
l9_127=l9_126;
...
#else
{
l9_78=vec4(Port_Input2_N110);
}
#endif
float l9_128=clamp((baseColor.w*l9_78.x)+0.001,Port_Input1_N113+0.001,Port_Input2_N113+0.001)-0.001;
vec4 l9_129=vec4(l9_77.x,l9_77.y,l9_77.z,vec4(0.0).w);
l9_129.w=l9_128;
...
#endif
sc_writeFragData0(max(l9_130,vec4(0.0)));
return;
}
vec4 l9_132;
...
vec4 l9_160=sc_OutputMotionVectorIfNeeded(max(l9_158,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_162-0.0039215689)),min(1.0,l9_162+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_164),packValue(l9_164),packValue(l9_164),packValue(l9_164)));
}
#endif
}
#else
