...
//sampler sampler rimTexSmpSC 0:28
...
//texture texture2D emissiveTex 0:4:0:25
//texture texture2D intensityTexture 0:5:0:26
//texture texture2D opacityTex 0:6:0:27
//texture texture2D rimTex 0:7:0:28
...
//texture texture2DArray emissiveTexArrSC 0:39:0:25
//texture texture2DArray intensityTextureArrSC 0:40:0:26
//texture texture2DArray opacityTexArrSC 0:41:0:27
//texture texture2DArray rimTexArrSC 0:42:0:28
...
//spec_const bool uv2EnableAnimation 97 0
//spec_const bool uv3EnableAnimation 98 0
//spec_const int NODE_13_DROPLIST_ITEM 99 0
//spec_const int NODE_27_DROPLIST_ITEM 100 0
//spec_const int NODE_38_DROPLIST_ITEM 101 0
//spec_const int NODE_49_DROPLIST_ITEM 102 0
//spec_const int NODE_69_DROPLIST_ITEM 103 0
//spec_const int NODE_76_DROPLIST_ITEM 104 0
//spec_const int SC_DEVICE_CLASS 105 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 106 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 107 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 108 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 109 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_rimTex 110 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 111 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 112 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 113 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 114 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_rimTex 115 -1
//spec_const int Tweak_N18 116 0
//spec_const int baseTexLayout 117 0
//spec_const int emissiveTexLayout 118 0
//spec_const int intensityTextureLayout 119 0
//spec_const int opacityTexLayout 120 0
//spec_const int rimTexLayout 121 0
...
//spec_const int sc_StereoViewID 129 0
//SG_REFLECTION_END
...
#endif
#ifndef rimTexHasSwappedViews
#define rimTexHasSwappedViews 0
#elif rimTexHasSwappedViews==1
#undef rimTexHasSwappedViews
#define rimTexHasSwappedViews 1
#endif
...
#endif
#ifndef rimTexLayout
#define rimTexLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_rimTex
#define SC_USE_UV_TRANSFORM_rimTex 0
#elif SC_USE_UV_TRANSFORM_rimTex==1
#undef SC_USE_UV_TRANSFORM_rimTex
#define SC_USE_UV_TRANSFORM_rimTex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_rimTex
#define SC_SOFTWARE_WRAP_MODE_U_rimTex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_rimTex
#define SC_SOFTWARE_WRAP_MODE_V_rimTex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_rimTex
#define SC_USE_UV_MIN_MAX_rimTex 0
#elif SC_USE_UV_MIN_MAX_rimTex==1
#undef SC_USE_UV_MIN_MAX_rimTex
#define SC_USE_UV_MIN_MAX_rimTex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_rimTex
#define SC_USE_CLAMP_TO_BORDER_rimTex 0
#elif SC_USE_CLAMP_TO_BORDER_rimTex==1
#undef SC_USE_CLAMP_TO_BORDER_rimTex
#define SC_USE_CLAMP_TO_BORDER_rimTex 1
#endif
...
uniform mat3 rimTexTransform;
uniform vec4 rimTexUvMinMax;
uniform vec4 rimTexBorderColor;
...
uniform sampler2D rimTex;
uniform sampler2DArray rimTexArrSC;
...
int rimTexGetStereoViewIndex()
{
int l9_0;
#if (rimTexHasSwappedViews)
{
l9_0=1-sc_GetStereoViewIndex();
}
#else
...
vec3 l9_9=l9_8.positionWS;
if (l9_8.id.x!=(sc_RayTracingCasterConfiguration.y&65535u))
{
return;
}
vec4 l9_10=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_9,1.0);
l9_7=l9_8.normalWS;
l9_6=l9_8.uv0;
l9_5=l9_8.uv1;
l9_4=l9_8.color;
l9_3=((l9_10.xy/vec2(l9_10.w))*0.5)+vec2(0.5);
l9_2=l9_8.viewDirWS;
l9_1=l9_9;
}
else
{
l9_7=normalize(varNormalAndMotion.xyz);
l9_6=varTex01.xy;
l9_5=varTex01.zw;
l9_4=varColor;
...
tempGlobals=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec2(0.0),vec2(0.0),l9_7,l9_6,l9_5,l9_4,l9_3,l9_2,l9_1);
...
#if (ENABLE_BASE_TEX)
{
vec2 l9_12=N7_getUV(NODE_27_DROPLIST_ITEM);
vec4 l9_13;
#if (baseTexLayout==2)
{
...
#if (ENABLE_RECOLOR)
{
vec3 l9_63=((recolorRed*l9_11.x)+(recolorGreen*l9_11.y))+(recolorBlue*l9_11.z);
l9_62=vec4(l9_63.x,l9_63.y,l9_63.z,l9_11.w);
}
#else
{
l9_62=l9_11;
...
{
vec2 l9_65=N7_getUV(NODE_69_DROPLIST_ITEM);
vec4 l9_66;
#if (opacityTexLayout==2)
{
bool l9_67=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_68=l9_65.x;
sc_SoftwareWrapEarly(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_69=l9_68;
float l9_70=l9_65.y;
sc_SoftwareWrapEarly(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_71=l9_70;
vec2 l9_72;
float l9_73;
...
{
l9_74=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_75=l9_69;
float l9_76=1.0;
sc_ClampUV(l9_75,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_74,l9_76);
float l9_77=l9_75;
float l9_78=l9_76;
bool l9_79;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_79=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_80=l9_71;
float l9_81=l9_78;
sc_ClampUV(l9_80,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_79,l9_81);
l9_73=l9_81;
...
#endif
vec2 l9_82=sc_TransformUV(l9_72,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_83=l9_82.x;
float l9_84=l9_73;
sc_SoftwareWrapLate(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_67,l9_84);
float l9_85=l9_82.y;
float l9_86=l9_84;
sc_SoftwareWrapLate(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_67,l9_86);
float l9_87=l9_86;
vec3 l9_88=sc_SamplingCoordsViewToGlobal(vec2(l9_83,l9_85),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_89=texture(opacityTexArrSC,l9_88,0.0);
vec4 l9_90;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_90=mix(opacityTexBorderColor,l9_89,vec4(l9_87));
}
#else
{
l9_90=l9_89;
...
vec4 l9_113=texture(opacityTex,l9_112.xy,0.0);
vec4 l9_114;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#endif
float l9_115=l9_64*l9_62.w;
vec4 l9_116;
float l9_117;
if (NODE_38_DROPLIST_ITEM==1)
{
l9_117=l9_115*tempGlobals.VertexColor.w;
l9_116=l9_62*tempGlobals.VertexColor;
}
else
{
l9_117=l9_115;
...
{
bool l9_121=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0));
float l9_122=l9_119.x;
sc_SoftwareWrapEarly(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_123=l9_122;
float l9_124=l9_119.y;
sc_SoftwareWrapEarly(l9_124,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_125=l9_124;
vec2 l9_126;
float l9_127;
...
{
l9_128=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
...
float l9_129=l9_123;
float l9_130=1.0;
sc_ClampUV(l9_129,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_128,l9_130);
float l9_131=l9_129;
float l9_132=l9_130;
bool l9_133;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_133=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
l9_133=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_134=l9_125;
float l9_135=l9_132;
sc_ClampUV(l9_134,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_133,l9_135);
l9_127=l9_135;
...
#endif
vec2 l9_136=sc_TransformUV(l9_126,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_137=l9_136.x;
float l9_138=l9_127;
sc_SoftwareWrapLate(l9_137,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,l9_121,l9_138);
float l9_139=l9_136.y;
float l9_140=l9_138;
sc_SoftwareWrapLate(l9_139,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,l9_121,l9_140);
float l9_141=l9_140;
vec3 l9_142=sc_SamplingCoordsViewToGlobal(vec2(l9_137,l9_139),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_143=texture(emissiveTexArrSC,l9_142,0.0);
vec4 l9_144;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_144=mix(emissiveTexBorderColor,l9_143,vec4(l9_141));
}
#else
{
l9_144=l9_143;
...
#else
{
bool l9_145=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0));
float l9_146=l9_119.x;
sc_SoftwareWrapEarly(l9_146,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_147=l9_146;
float l9_148=l9_119.y;
sc_SoftwareWrapEarly(l9_148,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_149=l9_148;
vec2 l9_150;
float l9_151;
#if (SC_USE_UV_MIN_MAX_emissiveTex)
...
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_152=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
...
float l9_153=l9_147;
float l9_154=1.0;
sc_ClampUV(l9_153,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_152,l9_154);
float l9_155=l9_153;
float l9_156=l9_154;
bool l9_157;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_157=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
l9_157=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_158=l9_149;
float l9_159=l9_156;
sc_ClampUV(l9_158,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_157,l9_159);
l9_151=l9_159;
...
#endif
vec2 l9_160=sc_TransformUV(l9_150,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_161=l9_160.x;
float l9_162=l9_151;
sc_SoftwareWrapLate(l9_161,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,l9_145,l9_162);
float l9_163=l9_160.y;
float l9_164=l9_162;
sc_SoftwareWrapLate(l9_163,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,l9_145,l9_164);
float l9_165=l9_164;
vec3 l9_166=sc_SamplingCoordsViewToGlobal(vec2(l9_161,l9_163),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_167=texture(emissiveTex,l9_166.xy,0.0);
vec4 l9_168;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_168=mix(emissiveTexBorderColor,l9_167,vec4(l9_165));
}
#else
{
l9_168=l9_167;
...
#endif
bool l9_169=NODE_38_DROPLIST_ITEM==2;
vec3 l9_170;
if (l9_169)
{
l9_170=l9_118+tempGlobals.VertexColor.xyz;
}
else
{
l9_170=l9_118;
...
vec3 l9_171;
if (l9_169||(int(ENABLE_EMISSIVE)!=0))
{
l9_171=ssPow((l9_170*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
else
{
l9_171=l9_170;
...
{
vec3 l9_173=rimColor*rimIntensity;
vec3 l9_174;
#if (Tweak_N9)
{
vec2 l9_175=N7_getUV(Tweak_N18);
vec4 l9_176;
#if (rimTexLayout==2)
{
bool l9_177=(int(SC_USE_CLAMP_TO_BORDER_rimTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimTex)!=0));
float l9_178=l9_175.x;
sc_SoftwareWrapEarly(l9_178,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).x);
float l9_179=l9_178;
float l9_180=l9_175.y;
sc_SoftwareWrapEarly(l9_180,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).y);
float l9_181=l9_180;
vec2 l9_182;
float l9_183;
#if (SC_USE_UV_MIN_MAX_rimTex)
{
bool l9_184;
#if (SC_USE_CLAMP_TO_BORDER_rimTex)
{
l9_184=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).x==3;
}
#else
{
l9_184=(int(SC_USE_CLAMP_TO_BORDER_rimTex)!=0);
}
#endif
float l9_185=l9_179;
float l9_186=1.0;
sc_ClampUV(l9_185,rimTexUvMinMax.x,rimTexUvMinMax.z,l9_184,l9_186);
float l9_187=l9_185;
float l9_188=l9_186;
bool l9_189;
#if (SC_USE_CLAMP_TO_BORDER_rimTex)
{
l9_189=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).y==3;
}
#else
{
l9_189=(int(SC_USE_CLAMP_TO_BORDER_rimTex)!=0);
}
#endif
float l9_190=l9_181;
float l9_191=l9_188;
sc_ClampUV(l9_190,rimTexUvMinMax.y,rimTexUvMinMax.w,l9_189,l9_191);
l9_183=l9_191;
...
#endif
vec2 l9_192=sc_TransformUV(l9_182,(int(SC_USE_UV_TRANSFORM_rimTex)!=0),rimTexTransform);
float l9_193=l9_192.x;
float l9_194=l9_183;
sc_SoftwareWrapLate(l9_193,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).x,l9_177,l9_194);
float l9_195=l9_192.y;
float l9_196=l9_194;
sc_SoftwareWrapLate(l9_195,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).y,l9_177,l9_196);
float l9_197=l9_196;
vec3 l9_198=sc_SamplingCoordsViewToGlobal(vec2(l9_193,l9_195),rimTexLayout,rimTexGetStereoViewIndex());
vec4 l9_199=texture(rimTexArrSC,l9_198,0.0);
vec4 l9_200;
#if (SC_USE_CLAMP_TO_BORDER_rimTex)
{
l9_200=mix(rimTexBorderColor,l9_199,vec4(l9_197));
}
#else
{
l9_200=l9_199;
...
#else
{
bool l9_201=(int(SC_USE_CLAMP_TO_BORDER_rimTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimTex)!=0));
float l9_202=l9_175.x;
sc_SoftwareWrapEarly(l9_202,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).x);
float l9_203=l9_202;
float l9_204=l9_175.y;
sc_SoftwareWrapEarly(l9_204,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).y);
float l9_205=l9_204;
vec2 l9_206;
float l9_207;
#if (SC_USE_UV_MIN_MAX_rimTex)
...
#if (SC_USE_CLAMP_TO_BORDER_rimTex)
{
l9_208=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).x==3;
}
#else
{
l9_208=(int(SC_USE_CLAMP_TO_BORDER_rimTex)!=0);
}
#endif
float l9_209=l9_203;
float l9_210=1.0;
sc_ClampUV(l9_209,rimTexUvMinMax.x,rimTexUvMinMax.z,l9_208,l9_210);
float l9_211=l9_209;
float l9_212=l9_210;
bool l9_213;
#if (SC_USE_CLAMP_TO_BORDER_rimTex)
{
l9_213=ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).y==3;
}
#else
{
l9_213=(int(SC_USE_CLAMP_TO_BORDER_rimTex)!=0);
}
#endif
float l9_214=l9_205;
float l9_215=l9_212;
sc_ClampUV(l9_214,rimTexUvMinMax.y,rimTexUvMinMax.w,l9_213,l9_215);
l9_207=l9_215;
l9_206=vec2(l9_211,l9_214);
}
#else
{
l9_207=1.0;
l9_206=vec2(l9_203,l9_205);
}
#endif
vec2 l9_216=sc_TransformUV(l9_206,(int(SC_USE_UV_TRANSFORM_rimTex)!=0),rimTexTransform);
float l9_217=l9_216.x;
float l9_218=l9_207;
sc_SoftwareWrapLate(l9_217,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).x,l9_201,l9_218);
float l9_219=l9_216.y;
float l9_220=l9_218;
sc_SoftwareWrapLate(l9_219,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimTex,SC_SOFTWARE_WRAP_MODE_V_rimTex).y,l9_201,l9_220);
float l9_221=l9_220;
vec3 l9_222=sc_SamplingCoordsViewToGlobal(vec2(l9_217,l9_219),rimTexLayout,rimTexGetStereoViewIndex());
vec4 l9_223=texture(rimTex,l9_222.xy,0.0);
vec4 l9_224;
#if (SC_USE_CLAMP_TO_BORDER_rimTex)
{
l9_224=mix(rimTexBorderColor,l9_223,vec4(l9_221));
}
#else
{
l9_224=l9_223;
...
#endif
vec3 l9_225=tempGlobals.VertexNormal_WorldSpace;
vec3 l9_226=tempGlobals.ViewDirWS;
float l9_227=abs(dot(normalize(l9_225),l9_226));
float l9_228;
if (!(int(rimInvert)!=0))
{
l9_228=1.0-l9_227;
...
{
l9_229=pow(l9_228,rimExponent);
}
vec3 l9_230;
#if (SC_DEVICE_CLASS>=2)
{
l9_230=vec3(pow(l9_174.x,2.2),pow(l9_174.y,2.2),pow(l9_174.z,2.2));
}
#else
{
l9_230=l9_174*l9_174;
}
#endif
l9_172=vec3(0.0)+(l9_230*l9_229);
}
#else
{
l9_172=vec3(0.0);
...
#endif
vec3 l9_231=l9_116.xyz+ssPow((l9_171+vec3(0.0))+l9_172,vec3(0.45454547));
...
#endif
sc_writeFragData0(max(l9_233,vec4(0.0)));
return;
}
vec4 l9_235;
...
{
l9_237=clamp(l9_117*2.0,0.0,1.0);
}
#else
{
float l9_238;
...
{
l9_238=clamp(dot(l9_232.xyz,vec3(l9_117)),0.0,1.0);
}
#else
{
float l9_239;
...
{
l9_240=(1.0-dot(l9_232.xyz,vec3(0.33333001)))*l9_117;
}
#else
{
float l9_241;
...
{
l9_241=(1.0-clamp(dot(l9_232.xyz,vec3(1.0)),0.0,1.0))*l9_117;
}
#else
{
float l9_242;
...
{
l9_242=clamp(dot(l9_232.xyz,vec3(1.0)),0.0,1.0)*l9_117;
}
#else
{
float l9_243;
#if (sc_BlendMode_Add)
{
l9_243=clamp(dot(l9_232.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_244;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_244=clamp(dot(l9_232.xyz,vec3(1.0)),0.0,1.0)*l9_117;
}
#else
{
float l9_245;
...
{
l9_245=dot(l9_232.xyz,vec3(0.33333001))*l9_117;
}
#else
{
float l9_246;
#if (sc_BlendMode_Min)
{
l9_246=1.0-clamp(dot(l9_232.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_247;
#if (sc_BlendMode_Max)
{
l9_247=clamp(dot(l9_232.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_247=1.0;
...
#endif
l9_235=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_232.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_236);
}
#else
{
vec4 l9_248;
...
{
l9_252=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_251,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_252=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_251,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_250=l9_252;
}
#endif
vec3 l9_253=mix(l9_250.xyz,definedBlend(l9_250.xyz,l9_232.xyz).xyz,vec3(l9_117));
...
#if (sc_Voxelization)
{
l9_255=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_256;
#if (sc_OutputBounds)
{
float l9_257=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_256=vec4(l9_257,1.0-l9_257,1.0,1.0);
}
#else
{
vec4 l9_258;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_258=vec4(mix(vec3(1.0),l9_232.xyz,vec3(l9_117)),l9_117);
}
#else
{
vec4 l9_259;
...
#endif
l9_259=vec4(l9_232.xyz*l9_260,l9_260);
}
#else
{
l9_259=l9_232;
...
vec4 l9_263=sc_OutputMotionVectorIfNeeded(max(l9_261,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_265-0.0039215689)),min(1.0,l9_265+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_267),packValue(l9_267),packValue(l9_267),packValue(l9_267)));
}
#endif
}
#else
