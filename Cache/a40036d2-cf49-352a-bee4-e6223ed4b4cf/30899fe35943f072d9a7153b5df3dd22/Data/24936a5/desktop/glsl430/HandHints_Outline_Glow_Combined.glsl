...
#endif
vec4 l9_118=vec4(min(vec4(l9_68.x,l9_68.y,l9_68.z,l9_67.w)+((l9_66*Port_Value_N017)*vec4(glowIntensity)),vec4(1.0)).xyz,l9_69.x);
#if (sc_BlendMode_AlphaTest)
{
if (l9_69.x<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_69.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_119,vec4(0.0)));
return;
}
vec4 l9_121;
...
{
l9_123=clamp(l9_69.x*2.0,0.0,1.0);
}
#else
{
float l9_124;
...
{
l9_124=clamp(dot(l9_118.xyz,vec3(l9_69.x)),0.0,1.0);
}
#else
{
float l9_125;
...
{
l9_126=(1.0-dot(l9_118.xyz,vec3(0.33333001)))*l9_69.x;
}
#else
{
float l9_127;
...
{
l9_127=(1.0-clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0))*l9_69.x;
}
#else
{
float l9_128;
...
{
l9_128=clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0)*l9_69.x;
}
#else
{
float l9_129;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_130=clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0)*l9_69.x;
}
#else
{
float l9_131;
...
{
l9_131=dot(l9_118.xyz,vec3(0.33333001))*l9_69.x;
}
#else
{
float l9_132;
...
#endif
vec3 l9_139=mix(l9_136.xyz,definedBlend(l9_136.xyz,l9_118.xyz).xyz,vec3(l9_69.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_144=vec4(mix(vec3(1.0),l9_118.xyz,vec3(l9_69.x)),l9_69.x);
}
#else
{
vec4 l9_145;
