...
//sampler sampler matcapTexSmpSC 0:23
...
//texture texture2D matcapTex 0:4:0:23
//texture texture2D normalTex 0:5:0:24
...
//texture texture2DArray matcapTexArrSC 0:35:0:23
//texture texture2DArray normalTexArrSC 0:36:0:24
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_matcapTex 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_matcapTex 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 87 -1
//spec_const int intensityTextureLayout 88 0
//spec_const int matcapTexLayout 89 0
//spec_const int normalTexLayout 90 0
...
l9_5=l9_10;
l9_4=l9_11;
l9_3=cross(l9_10,l9_11)*varTangent.w;
...
{
bool l9_15=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_16=l9_1.x;
sc_SoftwareWrapEarly(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_17=l9_16;
float l9_18=l9_1.y;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_19=l9_18;
vec2 l9_20;
float l9_21;
...
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_22=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_23=l9_17;
float l9_24=1.0;
sc_ClampUV(l9_23,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_22,l9_24);
float l9_25=l9_23;
float l9_26=l9_24;
bool l9_27;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_27=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_27=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_28=l9_19;
float l9_29=l9_26;
sc_ClampUV(l9_28,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_27,l9_29);
l9_21=l9_29;
...
#endif
vec2 l9_30=sc_TransformUV(l9_20,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_31=l9_30.x;
float l9_32=l9_21;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_15,l9_32);
float l9_33=l9_30.y;
float l9_34=l9_32;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_15,l9_34);
float l9_35=l9_34;
vec3 l9_36=sc_SamplingCoordsViewToGlobal(vec2(l9_31,l9_33),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_37=texture(normalTexArrSC,l9_36,0.0);
vec4 l9_38;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_38=mix(normalTexBorderColor,l9_37,vec4(l9_35));
}
#else
{
l9_38=l9_37;
...
#else
{
bool l9_39=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_40=l9_1.x;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_41=l9_40;
float l9_42=l9_1.y;
sc_SoftwareWrapEarly(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_43=l9_42;
vec2 l9_44;
float l9_45;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_46=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_47=l9_41;
float l9_48=1.0;
sc_ClampUV(l9_47,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_46,l9_48);
float l9_49=l9_47;
float l9_50=l9_48;
bool l9_51;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_51=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
...
float l9_52=l9_43;
float l9_53=l9_50;
sc_ClampUV(l9_52,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_51,l9_53);
l9_45=l9_53;
...
#endif
vec2 l9_54=sc_TransformUV(l9_44,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_55=l9_54.x;
float l9_56=l9_45;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_39,l9_56);
float l9_57=l9_54.y;
float l9_58=l9_56;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_39,l9_58);
float l9_59=l9_58;
vec3 l9_60=sc_SamplingCoordsViewToGlobal(vec2(l9_55,l9_57),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_61=texture(normalTex,l9_60.xy,0.0);
vec4 l9_62;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_62=mix(normalTexBorderColor,l9_61,vec4(l9_59));
}
#else
{
l9_62=l9_61;
...
#endif
l9_13=((l9_14.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_13=Port_Input2_N016;
}
#endif
mat3 l9_63=mat3(l9_4,l9_3,l9_5);
vec3 l9_64=l9_63*l9_13;
vec3 l9_65=-l9_2;
vec3 l9_66=normalize(l9_65);
vec3 l9_67;
if (clamp(Port_Import_N072,0.0,1.0)!=0.0)
{
int l9_68=sc_GetStereoViewIndex();
l9_67=mat3(sc_ViewMatrixArray[l9_68][0].xyz,sc_ViewMatrixArray[l9_68][1].xyz,sc_ViewMatrixArray[l9_68][2].xyz)*sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz;
}
else
{
l9_67=sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz;
}
vec3 l9_69=cross(l9_66,l9_67);
vec3 l9_70=normalize(l9_69);
vec3 l9_71=cross(l9_70,l9_66);
vec2 l9_72=((mat3(vec3(l9_70.x,l9_71.x,l9_66.x),vec3(l9_70.y,l9_71.y,l9_66.y),vec3(l9_70.z,l9_71.z,l9_66.z))*normalize(l9_64)).xy*0.5)+vec2(0.5);
vec4 l9_73;
#if (matcapTexLayout==2)
{
bool l9_74=(int(SC_USE_CLAMP_TO_BORDER_matcapTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTex)!=0));
float l9_75=l9_72.x;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).x);
float l9_76=l9_75;
float l9_77=l9_72.y;
sc_SoftwareWrapEarly(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).y);
float l9_78=l9_77;
vec2 l9_79;
float l9_80;
...
{
l9_81=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).x==3;
}
#else
{
l9_81=(int(SC_USE_CLAMP_TO_BORDER_matcapTex)!=0);
}
#endif
float l9_82=l9_76;
float l9_83=1.0;
sc_ClampUV(l9_82,matcapTexUvMinMax.x,matcapTexUvMinMax.z,l9_81,l9_83);
float l9_84=l9_82;
float l9_85=l9_83;
bool l9_86;
#if (SC_USE_CLAMP_TO_BORDER_matcapTex)
{
l9_86=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).y==3;
}
#else
{
l9_86=(int(SC_USE_CLAMP_TO_BORDER_matcapTex)!=0);
}
#endif
float l9_87=l9_78;
float l9_88=l9_85;
sc_ClampUV(l9_87,matcapTexUvMinMax.y,matcapTexUvMinMax.w,l9_86,l9_88);
l9_80=l9_88;
l9_79=vec2(l9_84,l9_87);
}
#else
...
#endif
vec2 l9_89=sc_TransformUV(l9_79,(int(SC_USE_UV_TRANSFORM_matcapTex)!=0),matcapTexTransform);
float l9_90=l9_89.x;
float l9_91=l9_80;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).x,l9_74,l9_91);
float l9_92=l9_89.y;
float l9_93=l9_91;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).y,l9_74,l9_93);
float l9_94=l9_93;
vec3 l9_95=sc_SamplingCoordsViewToGlobal(vec2(l9_90,l9_92),matcapTexLayout,matcapTexGetStereoViewIndex());
vec4 l9_96=texture(matcapTexArrSC,l9_95,0.0);
vec4 l9_97;
#if (SC_USE_CLAMP_TO_BORDER_matcapTex)
{
l9_97=mix(matcapTexBorderColor,l9_96,vec4(l9_94));
}
#else
{
l9_97=l9_96;
...
#else
{
bool l9_98=(int(SC_USE_CLAMP_TO_BORDER_matcapTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTex)!=0));
float l9_99=l9_72.x;
sc_SoftwareWrapEarly(l9_99,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).x);
float l9_100=l9_99;
float l9_101=l9_72.y;
sc_SoftwareWrapEarly(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).y);
float l9_102=l9_101;
vec2 l9_103;
float l9_104;
#if (SC_USE_UV_MIN_MAX_matcapTex)
...
#if (SC_USE_CLAMP_TO_BORDER_matcapTex)
{
l9_105=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).x==3;
}
#else
{
l9_105=(int(SC_USE_CLAMP_TO_BORDER_matcapTex)!=0);
}
#endif
float l9_106=l9_100;
float l9_107=1.0;
sc_ClampUV(l9_106,matcapTexUvMinMax.x,matcapTexUvMinMax.z,l9_105,l9_107);
float l9_108=l9_106;
float l9_109=l9_107;
bool l9_110;
#if (SC_USE_CLAMP_TO_BORDER_matcapTex)
{
l9_110=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).y==3;
}
#else
{
l9_110=(int(SC_USE_CLAMP_TO_BORDER_matcapTex)!=0);
}
#endif
float l9_111=l9_102;
float l9_112=l9_109;
sc_ClampUV(l9_111,matcapTexUvMinMax.y,matcapTexUvMinMax.w,l9_110,l9_112);
l9_104=l9_112;
...
#endif
vec2 l9_113=sc_TransformUV(l9_103,(int(SC_USE_UV_TRANSFORM_matcapTex)!=0),matcapTexTransform);
float l9_114=l9_113.x;
float l9_115=l9_104;
sc_SoftwareWrapLate(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).x,l9_98,l9_115);
float l9_116=l9_113.y;
float l9_117=l9_115;
sc_SoftwareWrapLate(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTex,SC_SOFTWARE_WRAP_MODE_V_matcapTex).y,l9_98,l9_117);
float l9_118=l9_117;
vec3 l9_119=sc_SamplingCoordsViewToGlobal(vec2(l9_114,l9_116),matcapTexLayout,matcapTexGetStereoViewIndex());
vec4 l9_120=texture(matcapTex,l9_119.xy,0.0);
vec4 l9_121;
#if (SC_USE_CLAMP_TO_BORDER_matcapTex)
{
l9_121=mix(matcapTexBorderColor,l9_120,vec4(l9_118));
}
#else
{
l9_121=l9_120;
...
#endif
l9_12=vec4(matcapIntensity)*l9_73;
}
#else
{
l9_12=vec4(Port_Input2_N023);
}
#endif
#if (sc_BlendMode_AlphaTest)
{
if (l9_12.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_12.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_126=clamp(l9_12.w*2.0,0.0,1.0);
}
#else
{
float l9_127;
...
{
l9_127=clamp(dot(l9_12.xyz,vec3(l9_12.w)),0.0,1.0);
}
#else
{
float l9_128;
...
{
l9_129=(1.0-dot(l9_12.xyz,vec3(0.33333001)))*l9_12.w;
}
#else
{
float l9_130;
...
{
l9_130=(1.0-clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0))*l9_12.w;
}
#else
{
float l9_131;
...
{
l9_131=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0)*l9_12.w;
}
#else
{
float l9_132;
#if (sc_BlendMode_Add)
{
l9_132=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_133;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_133=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0)*l9_12.w;
}
#else
{
float l9_134;
...
{
l9_134=dot(l9_12.xyz,vec3(0.33333001))*l9_12.w;
}
#else
{
float l9_135;
#if (sc_BlendMode_Min)
{
l9_135=1.0-clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_136;
#if (sc_BlendMode_Max)
{
l9_136=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_136=1.0;
...
#endif
l9_124=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_12.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_125);
}
#else
{
vec4 l9_137;
...
#endif
vec3 l9_142=mix(l9_139.xyz,definedBlend(l9_139.xyz,l9_12.xyz).xyz,vec3(l9_12.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_147=vec4(mix(vec3(1.0),l9_12.xyz,vec3(l9_12.w)),l9_12.w);
}
#else
{
vec4 l9_148;
...
#endif
l9_148=vec4(l9_12.xyz*l9_149,l9_149);
}
#else
{
l9_148=l9_12;
...
vec4 l9_152=sc_OutputMotionVectorIfNeeded(max(l9_150,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_154-0.0039215689)),min(1.0,l9_154+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_156),packValue(l9_156),packValue(l9_156),packValue(l9_156)));
}
#endif
}
#else
