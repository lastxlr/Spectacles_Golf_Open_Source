...
//spec_const bool ENABLE_ANIMATED 30 0
//spec_const bool ENABLE_ANIMATED_BASE 31 0
...
//spec_const int NODE_44_DROPLIST_ITEM 85 0
...
#endif
#ifndef NODE_44_DROPLIST_ITEM
#define NODE_44_DROPLIST_ITEM 0
#endif
#ifndef ENABLE_ANIMATED_BASE
#define ENABLE_ANIMATED_BASE 0
#elif ENABLE_ANIMATED_BASE==1
#undef ENABLE_ANIMATED_BASE
#define ENABLE_ANIMATED_BASE 1
#endif
#ifndef baseTexture
...
#define Tweak_N48 0
#endif
#ifndef ENABLE_ANIMATED
#define ENABLE_ANIMATED 0
#elif ENABLE_ANIMATED==1
#undef ENABLE_ANIMATED
#define ENABLE_ANIMATED 1
#endif
...
uniform vec2 Tweak_N41;
uniform float Tweak_N38;
uniform vec2 Port_Center_N026;
uniform mat3 baseTexTransform;
uniform vec4 baseTexUvMinMax;
uniform vec4 baseTexBorderColor;
uniform vec4 Tweak_N11;
uniform float Tweak_N12;
uniform float Tweak_N14;
uniform vec3 Port_Normal_N015;
uniform vec4 Port_Input0_N016;
uniform vec2 opacityScale;
uniform vec2 Tweak_N52;
uniform float Tweak_N53;
...
uniform sc_Camera_t sc_Camera;
uniform vec4 Port_Default_N021;
...
void Node42_Switch(float Switch,vec2 Value0,vec2 Value1,vec2 Default,out vec2 Result,ssGlobals Globals)
{
#if (NODE_44_DROPLIST_ITEM==0)
{
...
void Node51_Switch(float Switch,vec2 Value0,vec2 Value1,vec2 Default,out vec2 Result,ssGlobals Globals)
{
#if (Tweak_N48==0)
{
Value0=Globals.Surface_UVCoord0;
...
{
vec2 l9_16;
#if (ENABLE_ANIMATED_BASE)
{
vec2 l9_17;
Node42_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),l9_17,l9_14);
l9_16=(((l9_17-Port_Center_N026)*baseScale)+Port_Center_N026)+(Tweak_N41*(sc_Time.x*Tweak_N38));
}
#else
{
vec2 l9_18;
Node42_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),l9_18,l9_14);
l9_16=((l9_18-Port_Center_N026)*baseScale)+Port_Center_N026;
}
#endif
vec4 l9_19;
#if (baseTexLayout==2)
...
#else
{
l9_15=Port_Default_N021;
}
#endif
vec4 l9_68=baseColor*l9_15;
vec4 l9_69;
#if (ENABLE_RIM)
{
l9_69=mix(Port_Input0_N016,Tweak_N11,vec4(max(pow(1.0-abs(dot(-l9_2,mat3(l9_5,l9_3,l9_4)*Port_Normal_N015)),Tweak_N12),0.0)*Tweak_N14));
}
#else
{
l9_69=Port_Input2_N017;
}
#endif
vec4 l9_70=l9_68+l9_69;
float l9_71;
...
{
vec2 l9_73;
Node51_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),l9_73,l9_14);
l9_72=(((l9_73-Port_Center_N030)*opacityScale)+Port_Center_N030)+(Tweak_N52*(sc_Time.x*Tweak_N53));
}
#else
{
vec2 l9_74;
Node51_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),l9_74,l9_14);
l9_72=((l9_74-Port_Center_N030)*opacityScale)+Port_Center_N030;
}
#endif
vec4 l9_75;
...
#else
{
l9_71=Port_Default_N204;
}
#endif
float l9_124=l9_70.w*l9_71;
vec4 l9_125=vec4(l9_70.x,l9_70.y,l9_70.z,vec4(0.0).w);
l9_125.w=l9_124;
