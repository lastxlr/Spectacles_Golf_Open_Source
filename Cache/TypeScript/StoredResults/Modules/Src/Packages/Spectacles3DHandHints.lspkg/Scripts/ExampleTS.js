        ...
        onAwake() {
            ...
            switch (this.demoOption) {
                ...
                case 1: {
                    //play sequence
                    const sequence = [];
                    const itemA = new InteractionHintController_1.HandAnimationClipInfo(InteractionHintController_1.HandMode.Left, InteractionHintController_1.HandAnimationsLibrary.Left.PalmGrabY, new vec3(10, 0, 0));
                    const itemB = new InteractionHintController_1.HandAnimationClipInfo(InteractionHintController_1.HandMode.Right, InteractionHintController_1.HandAnimationsLibrary.Right.PalmGrabX);
                    sequence.push(itemA);
                    sequence.push(itemB);
